...
//Question 1: Yes.
//Question 2: Yes.
/*Question 3: My code was different, I copied the logic provided in the textbook
but it accomplished the same principle, Using a switch for the months to return 
specific ones with 28, 29, 30, and 31 days. and return an invalid choice
if outside of the 1 - 12 months */


//code provided from template
#include <iostream>
#include <fstream>
#include <iomanip>
#include <string>
...
int main()
{
	...
	do
	{
		...
		case '4': // print out the calendar of specified year to yourname.txt file
			...
			cout << "\n\tCalendar of year " << year << " has been printed to file " << fileName;
			break;
		case '5': // quit the program.
			cout << "\n\tThank you for using Steve's calendar program!\n\n"; // replaced FHSU with my name
			break;
...
void menu()
{
	...
	// Added 4th option to mimic sample run example
	cout << "\n\t* 4. Print calender of a given year to a file     *";
	cout << "\n\t* 5. Quit                                         *";
	cout << "\n\t***************************************************";
}
...
bool print_calendar(int year, string fileName)
{
	...
	ofstream file;
	// creates a fileName if not existant
	...
	for (int i = 1; i <= 12; i++) // print out 12 month calendar
	{
		print_calendar(i, year, file); // print out ith month
		file << endl;
	}
...
/*Output
	...
	***************************************************
	...
	Calendar of year 2016 has been printed to file subert.txt
