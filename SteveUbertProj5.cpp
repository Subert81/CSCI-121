...
//programming project 7 arithmetic
bool isLeapYear(int year)
{
...
int getMonthValue(int month, int year)
{
	...
	// Logic from textbook programming project 7
	switch (month)
	{
	case 1:
		if (isLeapYear(year))
...
//extra credit vaild year
bool isValid(int year)
{ // leap years must be later than 1582
	return year > 1582;
}
//extra credit valid month
bool isValid(int month, int year)
{ // Jan - Dec (months 1-12)
...
Invalid year. Please enter a year after 1582: ⌨1583
Year 1583 is NOT a leap year
*************************************
* Test Menu *
* 1. isLeapYear *
* 2. getCenturyValue *
...
*************************************
Please choose from menu: ⌨4
Please enter a year and month: ⌨2000 13
Invalid input. Please enter a year and month: ⌨2000 12
The month value is: 5
*************************************
* Test Menu *
* 1. isLeapYear *
* 2. getCenturyValue *
...
*************************************
Please choose from menu: ⌨6
Please enter a day of week (0 for Sunday, 1 for Monday, etc): ⌨8
The name of the day of the week is: Invalid date
*************************************
* Test Menu *
* 1. isLeapYear *
* 2. getCenturyValue *
